...
AddInput(TabCombat, "Distância Mínima", Settings.MinDistance, function(v) Settings.MinDistance = v end) -- NOVO
...
AddToggle(TabVisual, "Box 2D", Settings.ESP_Box, function(v) Settings.ESP_Box = v end) -- NOVO
AddColorPicker(TabVisual, "Cor da Box", "BoxColorIdx", nil) -- NOVO

AddToggle(TabVisual, "Tracers", Settings.ESP_Tracer, function(v) Settings.ESP_Tracer = v end) -- NOVO
AddColorPicker(TabVisual, "Cor da Linha", "TracerColorIdx", nil) -- NOVO

AddToggle(TabVisual, "Barra de Vida", Settings.ESP_Health, function(v) Settings.ESP_Health = v end) -- NOVO
